...
def salvar_papeleta_treinador(competicao, partida_id):
    ...
    try:
        contexto_atualizado = montar_contexto_treinador(partida_id, competicao, equipe.get("nome")) or contexto
        emitir_estado_partida(partida_id, _montar_payload_estado(contexto_atualizado))
    except Exception as e:
        print("ERRO emitir_estado_partida PAPELETA TREINADOR:", e)
